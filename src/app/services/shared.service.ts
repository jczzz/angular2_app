...
export class SharedService {
    ...
    findMovieURL1 = "https://api.themoviedb.org/3/search/movie?api_key=98325a9d3ed3ec225e41ccc4d360c817&language=en-US&query=";
    findMovieURL2 = "&page=1&include_adult=false"; 
